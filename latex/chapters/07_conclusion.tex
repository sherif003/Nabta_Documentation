...
Beyond disease diagnosis, the platform incorporates dedicated Random Forest machine learning models for crop recommendation and smart irrigation. The crop recommendation model achieved a test accuracy of \textbf{85.13\%}, while the irrigation decision model achieved a test accuracy of \textbf{98.53\%}. In addition, a Random Forest regression model estimated crop water requirements with a test $R^2$ score of \textbf{95.22\%}. Together, these models provide intelligent agricultural recommendations that support efficient crop selection and irrigation planning.
...
The complete platform was implemented as a production-ready web application using React.js, FastAPI, Firebase Authentication, Firestore, and cloud-hosted AI inference services. A modular architecture was adopted to facilitate scalability, maintainability, and future integration of additional intelligent agricultural services.
...
The final outcome of this project is not merely an individual deep learning model but a complete intelligent decision-support platform that combines computer vision, machine learning, explainable AI, large Large Language Models (LLMs), cloud computing, and modern web technologies within a single integrated agricultural ecosystem capable of supporting farmers throughout multiple stages of crop management.
...
Training and deploying multiple deep learning models—including YOLOv8, U-Net, CNN, and Large Language Models (LLMs)—require considerable computational resources. While inference is efficient on the deployed platform, model retraining remains computationally expensive.
...
The developed platform successfully integrates automated plant disease diagnosis, intelligent crop recommendation, smart irrigation recommendation, multilingual agricultural consultation, historical analytics, and cloud-based deployment into a single production-ready system. Experimental evaluation demonstrated strong performance across all intelligent modules. The CNN classification model achieved an overall accuracy of \textbf{95.0\%}, the YOLOv8x detection model achieved \textbf{78.8\% mAP@0.50}, and the U-Net segmentation model reached a best mean IoU of \textbf{94.73\%}. Furthermore, the crop recommendation model achieved a test accuracy of \textbf{85.13\%}, while the irrigation decision model achieved \textbf{98.53\%} accuracy and the water requirement model achieved a test $R^2$ score of \textbf{95.22\%}. These results confirm the effectiveness of the proposed multi-stage AI pipeline and intelligent decision-support modules for practical smart agriculture.
...
The authors believe that this work provides a solid foundation for future research and practical deployment of AI-powered smart agriculture systems. It is hoped that NABTA will contribute to improving agricultural productivity, resource utilization, and sustainable farming through the integration of modern artificial intelligence technologies.